...
public class RentalProvider extends LabelProvider implements ITreeContentProvider, IColorProvider {
	...
	public Color getForeground(Object element) {
		...
		/*
		 * 
		 * if (element instanceof RentalAgency) { return
		 * Display.getCurrent().getSystemColor(SWT.COLOR_BLUE); } if (element
		 * instanceof Rental) {
		 * 
		 * // return Display.getCurrent().getSystemColor(SWT.COLOR_GRAY); String
		 * objectColorString =
		 * RentalUIActivator.getDefault().getPreferenceStore().getString(
		 * RentalPreferencePage.RENTAL_COLOR); return
		 * getAColor(objectColorString); } if (element instanceof RentalObject)
		 * { // return Display.getCurrent().getSystemColor(SWT.COLOR_RED);
		 * String objectColorString =
		 * RentalUIActivator.getDefault().getPreferenceStore().getString(
		 * RentalPreferencePage.OBJECTS_COLOR); return
		 * getAColor(objectColorString); } if (element instanceof Customer) { //
		 * recup de la pref String customerColorString =
		 * RentalUIActivator.getDefault().getPreferenceStore().getString(
		 * RentalPreferencePage.CUSTOMER_COLOR); return
		 * getAColor(customerColorString); } return null;
		 * 
		 */
	...
	/**
	 * Recupere le foregroudColor d'un element (RentalAgency, Rental, Customer
	 * ou RentalObject) depuis la palette positionnée dans les prefs
	 * 
	 * @param element
	 * @return
	 */
	...
	/**
	 * Recupere le backgroudColor d'un element (RentalAgency, Rental, Customer
	 * ou RentalObject) depuis la palette positionnée dans les prefs
	 * 
	 * @param element
	 * @return
